...
<body>
  <form class="col-4 mx-auto border border-dark p-5 d-flex flex-column" action="connexion_post.php" method="post">
  ...
  <form class="col-4 mx-auto p-5 d-flex flex-column" action="inscription.php" method="post">
